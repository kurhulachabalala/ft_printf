...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/28 13:25:21 by kchabala          #+#    #+#             */
/*   Updated: 2018/09/28 13:25:27 by kchabala         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static short		ft_hand_x_digit(t_flist *lst, uintmax_t digit)
{
	short	len;
...
{
	if (lst->j)
		return (ft_hand_x_digit(lst, (uintmax_t)digit));
	else if (lst->ll)
		return (ft_hand_x_digit(lst, (unsigned long long)digit));
	else if (lst->z)
		return (ft_hand_x_digit(lst, (size_t)digit));
	else if (lst->l)
		return (ft_hand_x_digit(lst, (unsigned long)digit));
	else if (lst->h)
		return (ft_hand_x_digit(lst, (unsigned short)digit));
	else if (lst->hh)
		return (ft_hand_x_digit(lst, (unsigned char)digit));
	else
		return (ft_hand_x_digit(lst, (unsigned int)digit));
}
