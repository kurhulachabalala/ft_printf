...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/09/28 13:32:07 by kchabala          #+#    #+#             */
/*   Updated: 2018/09/28 13:32:10 by kchabala         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		ft_hand_uns_digit(t_flist *lst, uintmax_t digit)
{
	short				len;
...
{
	if (lst->spec == 'U')
		return (ft_hand_uns_digit(lst, (unsigned long)digit));
	else if (lst->j)
		return (ft_hand_uns_digit(lst, (uintmax_t)digit));
	else if (lst->ll)
		return (ft_hand_uns_digit(lst, (unsigned long long)digit));
	else if (lst->z)
		return (ft_hand_uns_digit(lst, (size_t)digit));
	else if (lst->l)
		return (ft_hand_uns_digit(lst, (unsigned long)digit));
	else if (lst->h)
		return (ft_hand_uns_digit(lst, (unsigned short)digit));
	else if (lst->hh)
		return (ft_hand_uns_digit(lst, (unsigned char)digit));
	else
		return (ft_hand_uns_digit(lst, (unsigned int)digit));
}
